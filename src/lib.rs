...
mod unit {
    ...
    fn interpret_help_message_simple_unnested_full() {
        ...
        assert_eq!(interpreted[1].1, expected_result);
    }
    ...
    fn interpret_help_message_extrabrackets_within_input_lines() {
        ...
        assert_eq!(valid_help_in[1].1, test::valid_getinfo_annotation());
    }
    ...
    fn interpret_help_message_getblockchaininfo_softforks_fragment() {
        ...
        assert_eq!(
            interpret_help_message(expected_incoming)[1].1,
            expected_result
        );
    }
    ...
    fn interpret_help_message_getblockchaininfo_enforce_and_reject_fragment() {
        ...
        assert_eq!(interpreted[1].1, expected_results);
    }
    ...
    fn interpret_help_message_getblockchaininfo_complete() {
        ...
        assert_eq!(
            expected,
            interpret_help_message(test::HELP_GETBLOCKCHAININFO_COMPLETE)[1].1
        );
    }
    ...
    fn serde_json_value_help_getinfo() {
        ...
        assert_eq!(getinfo_serde_json_value, help_getinfo[1].1);
    }
